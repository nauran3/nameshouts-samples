const ACCESS_TOKEN = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiJ9.eyJhdWQiOiIxIiwianRpIjoiNTVmOTdmZTBlZjA5ZjQ4NDZhOTNiOGMyMTk5ODY2MWVjZDgyNDUxYTQ5YTgxZDIwODZiZDJlMGQxYjg0ZGY2MTM3NzY3NDg0NDNjMDVjMmYiLCJpYXQiOjE3MTQ3Mzc5OTIsIm5iZiI6MTcxNDczNzk5MiwiZXhwIjoxNzQ2MjczOTkyLCJzdWIiOiI2NTQ1NCIsInNjb3BlcyI6W119.10N1vYo5ji89V3qwOFvSuC0YFe-xB0UFB4MV5szABhyVicUEcbgiVJBdNEDofOscbcNN9NRr6h3blGv543RFQd8DYdn0fLUezyCIaosrHSnF-YGk1UjEFoDvvKDpp-gu_WjsqVW12b6PaBis6D2GGO9_WY7jUE7FTiPiq7phInVMB90eOmtGhFHN5-UbGTmWOx32nsCpc-A63kd1BaRjx_AlXLiQjluIV6RtKExLBlKc-KQaeq3Pk9a4moPuNQG0JORBFRgAO26tD7ttR34Ie90eIdSQ0xn_Rdj6Onmx9XZofOX0ZkbJDZvU2vbx7Lobd9pAmGkUJJCkM4Fem2WJxJYDIz-2DTuUZi3ZQ5TvCMEgplznDAseCzQvtsmYr-DttRrk_BZsryiT8MbiYp9KJEFr0I34rMoW2KZuP7tLRTwb9LDW9unEgAD_w1biryilrGN_KgN8drfRwX5dDh2-91aP2_lhF1FgVaVrb_M46v9LiTwjEfuNMQNIKcTnOJY92HtDP-tBfySOTyTM-t_Y8xIsGWxJlXIHB4CjZLxbNUL5hxKn1Nxtaaj9WrqNaL-PGJQkUJyXmnpnmC2E2HMtriVVXeomDhpDGnuJ1SFwxjLKL02rj-hCLqSuHHWRD_T-3qgvu8ZW0sscbzh2eze4bC-nafTu16OvQwhuVd8gLqI';
...
function injectAudio(nameTag, nameToQuery, cssStyle, audioImgStyle, infoImgStyle, cardPosition, index, multiName, source, mulInstance) {
    ...
    $(`#${preLoadBtnId}`).hover(async function () {
        ...
        $(document).on("click", `#${audioImgBtnId}`, async function (e) {
            //get value of name from NamesLoaded Map from key (uuid)
